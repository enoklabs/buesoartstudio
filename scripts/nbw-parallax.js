...
$(document).ready(function() { //when the document is ready...
	...
	var tribalLeft = $(".tribal");
	var tribalRight = $(".tribal_sm");
	var flameLeft = $(".flame_left");
	var flameRight = $(".flame_right");
	...
	*/
	...
	function Move(){ 
		...
		if($secondBG.hasClass("inview")){
			//call the newPos function and change the background position
			$secondBG.css({'backgroundPosition': newPos(50, windowHeight, pos, 1250, 0.2)});
			//call the newPos function and change the secnond background position
			trainers.css({'backgroundPosition': newPos(50, windowHeight, pos, 1900, 0.5)});
			tribalLeft.css({'backgroundPosition': newPos(0, windowHeight, pos, 2700, 0.7)});
			tribalRight.css({'backgroundPosition': newPos(100, windowHeight, pos, 1700, 0.7)});
			flameLeft.css({'backgroundPosition': newPos(0, windowHeight, pos, 2000, 1.3)});
			flameRight.css({'backgroundPosition': newPos(100, windowHeight, pos, 2800, 1.3)});
		}
